        ...
        <div className="carousel-item active">
          ...
          <div className="container">
            <div className="carousel-caption text-start">
              ...
              <p><a href="#" className="btn btn-lg btn-primary" >Registrate Hoy</a></p>
            </div>
          </div>
        </div>
        <div className="carousel-item">
          ...
          <div className="container">
            <div className="carousel-caption">
              ...
              <p><a href="#" className="btn btn-lg btn-primary" >Learn more</a></p>
            </div>
          </div>
        </div>
        <div className="carousel-item">
          ...
          <div className="container">
            <div className="carousel-caption text-end">
              ...
              <p><a   href="#" className="btn btn-lg btn-primary">Browse gallery</a></p>
            </div>
          </div>
        </div>
      </div>
